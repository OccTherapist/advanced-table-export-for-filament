...
class TableExportOptionsFactory
{
    ...
    public static function make(array $overrides = []): TableExportOptions
    {
        return new TableExportOptions(
            ...
            disableAdditionalColumns: $overrides['disableAdditionalColumns'] ?? false,
            ...
            additionalColumnsFieldLabel: $overrides['additionalColumnsFieldLabel'] ?? null,
            additionalColumnsTitleFieldLabel: $overrides['additionalColumnsTitleFieldLabel'] ?? null,
            additionalColumnsDefaultValueFieldLabel: $overrides['additionalColumnsDefaultValueFieldLabel'] ?? null,
            additionalColumnsAddButtonLabel: $overrides['additionalColumnsAddButtonLabel'] ?? null,
